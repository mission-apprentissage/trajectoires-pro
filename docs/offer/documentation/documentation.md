...
- [📚 Centre de documentation InserJeunes]({{ site.baseurl }}{% link offer/documentation/documentation-general.md %})
...
- [Réutilisation des données InserJeunes sur un site tiers]({{ site.baseurl }}{% link offer/guide/guide-reuse.md %})
- [Faire le lien entre votre catalogue et les données InserJeunes]({{ site.baseurl }}{% link offer/guide/guide-connect.md %})

...
const config = {
  ...
  millesimes: {
    default: env.get("TRAJECTOIRES_PRO_MILLESIMES").default("2020,2021,2022,2023,2024").asArray(),
    defaultSup: env.get("MILLESIMES_SUP").default("2019,2020,2021,2022,2023,2024").asArray(),
    formations: env
      .get("TRAJECTOIRES_PRO_MILLESIMES_FORMATIONS")
      .default("2019_2020,2020_2021,2021_2022,2022_2023,2023_2024")
      .asArray(),
    formationsSup: env
      .get("MILLESIMES_FORMATIONS_SUP")
      .default("2019_2020,2020_2021,2021_2022,2022_2023,2023_2024")
      .asArray(),
    regionales: env

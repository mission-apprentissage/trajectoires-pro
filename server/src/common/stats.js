...
export async function getFilieresStats(collection, cfd, millesime = null, region = null, departement = null) {
    ...
    .aggregate([
      {
        $match: {
          ...
          ...(departement ? { "departement.code": departement } : {}),
        },
      },
      {
        $group: {
          ...
          ...(departement ? { departement: { $first: "$departement" } } : {}),

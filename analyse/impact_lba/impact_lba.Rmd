...
sketch = htmltools::withTags(table(
  ...
  thead(
    tr(
      th(rowspan = 2, 'Affichage des données IJ en 2024'),
      th(colspan = 3, 'Demandes de rdv'),
      th(colspan = 3, 'Visites'),
      th(colspan = 3, 'Demandes de rdv pour 1000 Visites'),
    ),
    tr(
      lapply(rep(c('2023', '2024',"Evolution"), 3), th)
    )
  )
))

DT::datatable(temp, container = sketch, rownames = FALSE,options = list(dom = 't',ordering=F))
...
sketch = htmltools::withTags(table(
  ...
  thead(
    tr(
      th(rowspan = 2, 'Avant/Après le bac'),
      th(colspan = 3, 'Demandes de rdv'),
      th(colspan = 3, 'Visites'),
      th(colspan = 3, 'Demandes de rdv pour 1000 Visites'),
    ),
...
sketch = htmltools::withTags(table(
  ...
  thead(
    tr(
      th(rowspan = 2, 'Avant/Après le bac'),
      th(rowspan = 2, 'Groupe de taux de devenir favorable'),
      th(colspan = 3, 'Demandes de rdv'),
      th(colspan = 3, 'Visites'),
      th(colspan = 3, 'Demandes de rdv pour 1000 Visites'),
    ),
...
sketch = htmltools::withTags(table(
  ...
  thead(
    tr(
      th(rowspan = 2, 'Avant/Après le bac'),
      th(rowspan = 2, 'Groupe de taux en emploi et en formation'),
      th(colspan = 3, 'Demandes de rdv'),
      th(colspan = 3, 'Visites'),
      th(colspan = 3, 'Demandes de rdv pour 1000 Visites'),
    ),
